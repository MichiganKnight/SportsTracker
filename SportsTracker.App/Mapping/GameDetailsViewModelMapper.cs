...
{
    public interface IGameDetailsViewModelMapper
    {
        GameDetailsViewModel Map(GameDetails details);
    }
    
    public sealed class GameDetailsViewModelMapper : IGameDetailsViewModelMapper
    {
        public GameDetailsViewModel Map(GameDetails details)
        {
            string? location = BuildLocation(details.VenueCity, details.VenueState);
